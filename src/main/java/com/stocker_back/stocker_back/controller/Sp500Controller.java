...
public class Sp500Controller {
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "201", description = "S&P 500 리스트 업데이트 성공"),
    ...
    public ResponseEntity<?> updateSp500List() {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success(Map.of("updatedCount", updatedSymbols.size())));
        } catch (Exception e) {
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "S&P 500 심볼 목록 조회 성공"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @GetMapping
    public ResponseEntity<?> getSp500Symbols() {
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success(Map.of("count", stockList.size())));
        } catch (Exception e) {
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "S&P 500 테이블 데이터 조회 성공"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @GetMapping("/table")
    public ResponseEntity<?> getSp500TableData() {
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success(Map.of("count", tableData.size())));
        } catch (Exception e) {
